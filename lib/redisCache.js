            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        key = this.defineKey(id);
                        if (!this.expiry) return [3 /*break*/, 3];
                        return [4 /*yield*/, (typeof this.expiry == 'function' ? this.expiry(data) : this.expiry)];
                    case 1:
                        opt = _a.sent();
                        return [4 /*yield*/, this.client.set(key, json, opt.expiryMode, opt.time)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
