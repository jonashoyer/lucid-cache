...
var LocalCache = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (typeof this.options.ttl == 'function' ? this.options.ttl(data) : this.options.ttl)];
                    case 1:
                        time = _a.sent();
                        this.cache[id] = { data: data, lastUsed: Date.now(), expireAt: time ? Date.now() + time : undefined };
                        return [2 /*return*/];
                }
            });
        });
    ...
    LocalCache.prototype.ttl = function (id, ttl) {
        var e = this.cache[id];
        if (ttl) {
            if (!e)
                return null;
        ...
        if (!(e === null || e === void 0 ? void 0 : e.expireAt))
            return null;
        var now = Date.now();
        if (e.expireAt < now)
            return null;
